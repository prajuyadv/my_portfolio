...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(
    () => ({
      python: [
        'print("Hello, World! 👋 I\'m Praju Kumar Yadav Patnam")',
        'print("Based in United States 🇺🇸")',
        'print("Software  Developer 🚀 Building modern cross-platform apps with animations, WebSockets, and scalable backend APIs.")',
      ],
      javascript: [
        'console.log("Hello, World! 👋 I\'m Praju Kumar Yadav Patnam");',
        'console.log("Based in United States 🇺🇸");',
        'console.log("Software Developer 🚀 Building modern cross-platform apps with animations, WebSockets, and scalable backend APIs.");',
      ],
    }),
    []
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">PrajuKumarYadavPatnam@portfolio:~$</span>
